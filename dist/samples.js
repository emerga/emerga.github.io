...
var Sample = /*#__PURE__*/function () {
  ...
  _createClass(Sample, [{
    ...
    key: "run",
    value: function run() {
      this.emerga.context.beginPath();
      this.emerga.context.arc(95, 50, 40, 0, 2 * Math.PI);
      this.emerga.context.stroke();
    }
  }]);
...
var sample = __webpack_require__(/*! ./sample */ "./src/scripts/sample.js");
