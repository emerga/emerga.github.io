...
var FractalOfLife = /*#__PURE__*/function () {
  ...
  _createClass(FractalOfLife, [{
    ...
    value: function settingsUpdated() {
      ...
      if (this.stateMachine && !this.stateMachine.halted) stopStateMachine(startStateMachine);
    }
    /**
     * 
     */
...
var g;
module.exports = {
  initInterface: function initInterface(app) {
  ...
  initToolbar: function initToolbar(app) {
    $('#toolbar').w2toolbar({
      name: 'toolbar',
      items: [{
        type: 'check',
