...
var FractalOfLife = /*#__PURE__*/function () {
  ...
  _createClass(FractalOfLife, [{
    ...
    value: function settingsUpdated() {
      ...
      var self = this;
      if (!this.inited) return; // stop the state machine

      var stopStateMachine = function stopStateMachine(cb) {
        _this.stateMachine.stop(cb);
      };

      if (this.stateMachine && !this.stateMachine.halted) stopStateMachine(this.startStateMachine);
    }
    /**
     * 
     */
