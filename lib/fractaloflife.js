...
var FractalOfLife = /*#__PURE__*/function () {
  function FractalOfLife(emerga) {
    ...
    this.numIterations = this._numIterations = 3;
    this.scaleFactor = this._scaleFactor = 256;
    this.offset = 600;
    this.useFabric = false;
    this.resetting = false;
    this.usePoints = this._usePoints = false;
    this.useLines = this._useLines = true;
    this.pointScale = this._pointScale = 16;
    this.variablePointSize = this._variablePointSize = false;
    this.variableLineThickness = this._variableLineThickness = false;
    this.lineThickness = this._lineThickness = 1;
    this.lineBrightness = this._lineBrightness = 5;
