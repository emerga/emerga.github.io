...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/scripts/fractal-of-life/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/lib/bloom-element.js":
/*!**********************************!*\
  !*** ./src/lib/bloom-element.js ***!
  \**********************************/
/*! exports provided: BloomElement */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BloomElement", function() { return BloomElement; });
...
var state = __webpack_require__(/*! ./state-machine */ "./src/lib/state-machine.js");
  ...
  _createClass(BloomElement, [{
    ...
    value: function bloom(el, iter, cb) {
      ...
      for (var i = start; i < end; i++) {
        ...
        angle = self.flipNegatives && angle < 0 ? 360 - angle : angle;
        angle = self.skew && angle < self.skewAngle ? self.skewAngle - angle : angle;
...
/*!**************************!*\
  !*** ./src/lib/color.js ***!
  \**************************/
/*! exports provided: hslToRgb, getRgb, rgbToHex, fullColor, offset */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(module) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hslToRgb", function() { return hslToRgb; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRgb", function() { return getRgb; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "rgbToHex", function() { return rgbToHex; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fullColor", function() { return fullColor; });
...
function getRgb(level) {
  if (!module.colorRgbMap) module.colorRgbMap = [];

  if (module.colorRgbMap[level] == null) {
    // Keep hue value in range [0, 1]
    var hue = level / 10 % 1;
    var rgb = hslToRgb(hue, 0.5, 0.5);
    module.colorRgbMap[level] = rgb;
  }

  return module.colorRgbMap[level];
}
...
var BloomElement = __webpack_require__(/*! ./bloom-element */ "./src/lib/bloom-element.js").BloomElement;

var singleton;

var GenerativeStateMachineRules = /*#__PURE__*/function () {
  function GenerativeStateMachineRules(machine) {
    _classCallCheck(this, GenerativeStateMachineRules);

    this.machine = machine;
    this._branchAngle = 54;
    this._segments = 5;
  ...
  _createClass(GenerativeStateMachineRules, [{
    key: "settingsUpdated",
    value: function settingsUpdated() {
      this.machine.stop();
      this.machine.doEmitReset();
    }
  }, {
    key: "flipNegatives",
    get: function get() {
      return this._flipNegatives;
    },
    set: function set(v) {
      this._flipNegatives = v;
    ...
    key: "segmentStartIndex",
    get: function get() {
      return this._segmentStartIndex;
    },
    set: function set(v) {
      this._segmentStartIndex = v;
      this.settingsUpdated();
    }
  }]);

  return GenerativeStateMachineRules;
}();

var GenerativeStateMachine = /*#__PURE__*/function (_state$StateMachine) {
  _inherits(GenerativeStateMachine, _state$StateMachine);

  var _super = _createSuper(GenerativeStateMachine);

  function GenerativeStateMachine() {
    var _this;

    _classCallCheck(this, GenerativeStateMachine);
    ...
    _this._rules = new GenerativeStateMachineRules(_assertThisInitialized(_this));

    var machine = _assertThisInitialized(_this);

    _this.builders.add(new state.StateBuilder(machine, null, function (el, iter) {
    ...
    _this.postIteration = function (machine, els, iter) {
      machine.doEmitIteration(els);
      machine.elements.clear();
      machine.elements.add(els);
    };

    _this.renderers.add(new state.StateRenderer(machine, null, function (el) {
  ...
  _createClass(GenerativeStateMachine, [{
    key: "doEmitElement",
    value: function doEmitElement(el) {
      if (this.onEmitElement) this.onEmitElement(this, el);
    }
  }, {
    key: "doEmitIteration",
    value: function doEmitIteration(els) {
      if (this.onEmitIteration) this.onEmitIteration(this, els);
    }
  }, {
    key: "doEmitReset",
    value: function doEmitReset() {
      if (this.onEmitReset) this.onEmitReset(this);
    }
  }, {
    key: "rules",
    get: function get() {
    ...
    key: "onEmitElement",
    get: function get() {
      return this._onEmitElement;
    },
    set: function set(v) {
      this._onEmitElement = v;
    }
  }, {
    key: "onEmitIteration",
    get: function get() {
      return this._onEmitIteration;
    },
    set: function set(v) {
      this._onEmitIteration = v;
    }
  }, {
    key: "onEmitReset",
    get: function get() {
      return this._onEmitReset;
    },
    set: function set(v) {
      this._onEmitReset = v;
    }
  ...
  return GenerativeStateMachine;
}(state.StateMachine);

module.exports = {
  GenerativeStateMachine: GenerativeStateMachine
};
...
/*!**********************************!*\
  !*** ./src/lib/state-machine.js ***!
  \**********************************/
/*! exports provided: StateElement, StateMachineCollection, StateMachineAssociativeCollection, StateMachine, EntityElement, StateRenderer, StateBuilder, StateMachineBreakException */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StateMachineAssociativeCollection", function() { return StateMachineAssociativeCollection; });
...
var StateMachineAssociativeCollection = /*#__PURE__*/function (_StateMachineCollecti) {
  _inherits(StateMachineAssociativeCollection, _StateMachineCollecti);

  var _super = _createSuper(StateMachineAssociativeCollection);

  function StateMachineAssociativeCollection(machine) {
    var _this;

    _classCallCheck(this, StateMachineAssociativeCollection);

    _this = _super.call(this, machine);
    _this._elements = {};
    return _this;
  }

  _createClass(StateMachineAssociativeCollection, [{
    key: "add",
    value: function add(key, el) {
  ...
  return StateMachineAssociativeCollection;
...
var EntityElement = /*#__PURE__*/function (_StateElement) {
  ...
  var _super2 = _createSuper(EntityElement);
  ...
  function EntityElement(machine, state, callback) {
    ...
    _this2 = _super2.call(this, machine, state, callback);
...
var StateRenderer = /*#__PURE__*/function (_StateElement2) {
  ...
  var _super3 = _createSuper(StateRenderer);
...
var StateMachine = /*#__PURE__*/function () {
  ...
  _createClass(StateMachine, [{
    ...
    key: "operateOnElement",
    value: function operateOnElement(stateEl) {
      return stateEl.execute(this.iteration);
    }
  }, {
    key: "renderElement",
    value: function renderElement(stateEl) {
      this.renderers.elements[0].execute(this.iteration, stateEl);
    }
  }, {
    key: "processElement",
    value: function processElement() {
      ...
      if (this.curElements.length === 0) {
        ...
        this.iteration++;
        this.remIterations = this.remIterations > 0 ? this.remIterations - 1 : this.remIterations;
        return setTimeout(function () {
          return machine._advance();
        }, 0);
      }

      var curElement = this.curElements.pop();
      var els = this.operateOnElement(curElement);
    ...
    key: "processElementAsync",
    value: function processElementAsync() {
      var _this3 = this;
      ...
      if (this.paused) {
        return setTimeout(function () {
          return machine.processElementAsync();
        }, 100);
      }
      ...
      var curElement = this.curElements.pop();
      setTimeout(function () {
        var els = _this3.operateOnElement(curElement);

        _this3.renderElement(curElement);

        _this3.newElements = _this3.newElements.concat(els);
    ...
    value: function _advance() {
      ...
      if (this.remIterations === 0 || this.halt) {
        return;
      }

      this.curElements = this.elements.toArray();
      Promise.resolve().then(function () {
        return machine.asyncCompute ? machine.processElementAsync() : machine.processElement();
      });
    }
  }, {
    key: "advance",
...
var gen = __webpack_require__(/*! ../../lib/gen-state-machine */ "./src/lib/gen-state-machine.js");
...
var FractalOfLife = /*#__PURE__*/function () {
  ...
  function FractalOfLife(emerga) {
    ...
    this._ui = __webpack_require__(/*! ./ui */ "./src/scripts/fractal-of-life/ui.js");
    this._drawnElements = 0;
  ...
  _createClass(FractalOfLife, [{
    ...
    value: function setupStateMachine() {
      ...
      if (this.stateMachine) {
        smRules = this.stateMachine.rules;
      }

      this.stateMachine = new gen.GenerativeStateMachine();

      if (smRules) {
        this.stateMachine.rules = smRules;
      }

      this.stateMachine.asyncCompute = this.asyncRender;
      this.stateMachine.onEmitElement = this.elementEmitted;
      this.stateMachine.onEmitReset = this.settingsUpdated;
    }
    /**
     * 
     */
...
/***/ "./src/scripts/fractal-of-life/ui.js":
/*!*******************************************!*\
  !*** ./src/scripts/fractal-of-life/ui.js ***!
  \*******************************************/
/*! exports provided: initUI, animate, addToRender, initCanvas */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var color = __webpack_require__(/*! ../../lib/color */ "./src/lib/color.js");
...
var RenderingSettings = /*#__PURE__*/function () {
  function RenderingSettings(app) {
    _classCallCheck(this, RenderingSettings);
    ...
    this._lineBrightness = 200;
    this._globalCompositeOperation = 'lighter';
  }

  _createClass(RenderingSettings, [{
    key: "scaleFactor",
    get: function get() {
    ...
    key: "variablePointSize",
    get: function get() {
      return this._variablePointSize;
    },
    set: function set(v) {
    ...
    key: "variableLineThickness",
    get: function get() {
      return this._variableLineThickness;
    },
    set: function set(v) {
    ...
    key: "lineBrightness",
    get: function get() {
      return this._lineBrightness;
    },
    set: function set(v) {
      this._lineBrightness = v;
      this.app.settingsUpdated();
    }
  }, {
...
var initCanvas = function initCanvas(app) {
  // remove old wrapper
  var curCanv = document.getElementById('wrapper');
  if (curCanv) curCanv.parentNode.removeChild(curCanv); // create new wrapper

  var container = document.createElement('div');
  container.id = 'wrapper';
  document.body.appendChild(container); // create canvas element
...
var clearCanvas = function clearCanvas(app) {
  app.emerga.context.fillColor = 'rgba(255,255,255,1)';
  app.emerga.context.fillRect(0, 0, app.emerga.canvas.width, app.emerga.canvas.height);
};
/**
 * 
 * @param {*} app 
...
var initToolbar = function initToolbar(app) {
...
var initControls = function initControls(app) {
  g = app.emerga.guis['gui'];
  var folder = g.addFolder('Starting Conditions');
  folder.add(app.stateMachine.rules, 'segments').min(2).step(1).onChange(app.settingsUpdated());
  folder.add(app, 'numIterations').min(1).step(1).onChange(app.settingsUpdated());
  folder.add(app.stateMachine.rules, 'branchAngle', 1, 359).onChange(app.settingsUpdated());
  folder.add(app.stateMachine.rules, 'twistFactor', -10, 10).onChange(app.settingsUpdated());
  folder.add(app.stateMachine.rules, 'segmentStartIndex', 0, 5).onChange(app.settingsUpdated());
  folder.add(app.stateMachine.rules, 'flipNegatives', 0, 5).onChange(app.settingsUpdated());
  folder.add(app.stateMachine.rules, 'skew').onChange(app.settingsUpdated());
  folder.add(app.stateMachine.rules, 'skewAngle', -359, 359).onChange(app.settingsUpdated());
  folder.open();
  folder = g.addFolder('Rendering');
  folder.add(app, 'asyncRender').onChange(app.settingsUpdated());
  folder.add(renderSettings, 'usePoints').onChange(app.settingsUpdated());
  folder.add(renderSettings, 'useLines').onChange(app.settingsUpdated());
  folder.add(renderSettings, 'pointScale').onChange(app.settingsUpdated());
  folder.add(renderSettings, 'variablePointSize').onChange(app.settingsUpdated());
  folder.add(renderSettings, 'variableLineThickness').onChange(app.settingsUpdated());
  folder.add(renderSettings, 'lineThickness').onChange(app.settingsUpdated());
  folder.add(renderSettings, 'lineBrightness').onChange(app.settingsUpdated());
  folder.add(renderSettings, 'globalCompositeOperation', ['source-over', 'source-in', 'source-out', 'source-stop', 'destination-over', 'destination-in', 'destination-out', 'destination-stop', 'lighter', 'copy', 'xor', 'multiply', 'screen', 'overlay', 'darken', 'lighten', 'color-dodge', 'color-burn', 'hard-light', 'difference', 'exclusion', 'hue', 'saturation', 'color', 'luminosity']).onChange(app.settingsUpdated());
  folder.open();
  g.remember(app);
  folder = g.addFolder('Scaling');
  folder.add(renderSettings, 'scaleFactor', 1, 8192).onChange(app.settingsUpdated());
  folder.open();
};

var renderElement = function renderElement(app, el) {
  var iter = app.stateMachine.iteration;
  var strokeWidth = iter > 8 ? 1 : 8 / iter;
  strokeWidth = renderSettings.variableLineThickness ? renderSettings.lineThickness * strokeWidth / 2 : renderSettings.lineThickness;
  var strokeStyle = fullColor(getRgb(iter), 0.01 * renderSettings.lineBrightness);
  var pointSize = renderSettings.variablePointSize ? renderSettings.scaleFactor / (iter * renderSettings.pointScale) : renderSettings.pointScale;
  var ctx = app.emerga.context;
  ctx.globalCompositeOperation = renderSettings.globalCompositeOperation; //

  var drawLine = function drawLine(start, end) {
    ctx.strokeStyle = strokeStyle;

    if (renderSettings.useLines) {
      ctx.lineWidth = renderSettings.lineThickness;
      ctx.strokeWidth = strokeWidth;
      ctx.moveTo(start[0], start[1]);
      ctx.lineTo(end[0], end[1]);
    }

    if (renderSettings.usePoints) {
      ctx.lineWidth = 1;
      ctx.fillStyle = strokeStyle;
      ctx.arc(start[0], start[1], pointSize, 0, 2 * Math.PI, false);
      ctx.fill();
    }
  };

  if (app.stateMachine.halted) {
    return clearCanvas(app);
  }

  var originCoords = offset(el.origin(renderSettings.scaleFactor), renderSettings.offset);
  ctx.beginPath();
  el.children.forEach(function (child) {
    var childCoords = offset(child.origin(renderSettings.scaleFactor), renderSettings.offset);
...
var addToRender = function addToRender(el) {
  if (Array.isArray(el)) {
    elementsToRender = el;
  } else {
...
var animate = function animate(app) {
  clearCanvas(app);
...
/******/ });
//# sourceMappingURL=fractaloflife.js.map