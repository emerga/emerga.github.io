...
var Cell = /*#__PURE__*/function (_state$EntityElement) {
  ...
  _createClass(Cell, [{
    ...
    value: function nextState() {
      ...
      return this.cellState ? neighbors === 2 || neighbors === 3 : neighbors == 3;
    }
  }, {
    key: "id",
    get: function get() {
  ...
  function ConwayStateMachine(width, height, cellSize, percentAlive) {
    ...
    _this3.postIteration = function (machine, els) {
      ...
      els.forEach(function (el) {
        gn += el.cellState ? (el.x * 100 + el.y) / 100 : 0;
...
/*!**********************************!*\
  !*** ./src/lib/state-machine.js ***!
  \**********************************/
/*! exports provided: StateElement, StateMachineCollection, StateMachineAssociativeCollection, StateMachine, EntityElement, StateOperator, StateRenderer, StateBuilder, StateMachineBreakException */
...
var StateOperator = /*#__PURE__*/function (_StateElement3) {
  ...
  var _super4 = _createSuper(StateOperator);
...
var StateBuilder = /*#__PURE__*/function (_StateElement4) {
  ...
  var _super5 = _createSuper(StateBuilder);
...
var GameOfLife = /*#__PURE__*/function () {
  ...
  _createClass(GameOfLife, [{
    ...
    value: function setupStateMachine() {
      this.stateMachine = new conway.ConwayStateMachine(90, 60, this._cellSize, this._percentAlive);
...
var initControls = function initControls(app) {
  ...
  folder.add(app, 'cellSize', 1, 100).step(1).onChange(app.settingsUpdated());
